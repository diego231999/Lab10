                ...
                <div class="col-md-6">
                    ...
                    <form method="POST" action="<%=request.getContextPath()%>/DepartmentServlet?action=crear">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="managerId" value="<%=department.getManagerId()%>">
                        </div>
                        <div class="form-group">
                            <label>Location Id</label>
                            <input type="text" class="form-control" name="locationId" value="<%=department.getLocationId()%>">
                        </div>                           
